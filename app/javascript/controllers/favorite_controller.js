...
export default class extends Controller {
  ...
  favorite(event) {
    ...
    this.heartIconTarget.classList.toggle("fa-regular", !this.element.dataset.favorite);
    this.heartIconTarget.classList.toggle("fa-solid", this.element.dataset.favorite);
  }
}
